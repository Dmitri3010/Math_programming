========================================================================
    КОНСОЛЬНОЕ ПРИЛОЖЕНИЕ. Обзор проекта lab1_2_v6_Генератор сочетаний
========================================================================

Это приложение lab1_2_v6_Генератор сочетаний создано автоматически с помощью мастера приложений.

В этом файле представлена сводка содержимого всех файлов, входящих в состав приложения lab1_2_v6_Генератор сочетаний.


lab1_2_v6_Генератор сочетаний.vcxproj
...
lab1_2_v6_Генератор сочетаний.vcxproj.filters
...
lab1_2_v6_Генератор сочетаний.cpp
...
StdAfx.h, StdAfx.cpp
    Эти файлы используются для построения файла предкомпилированного заголовка (PCH) с именем lab1_2_v6_Генератор сочетаний.pch и файла предкомпилированных типов с именем StdAfx.obj.
